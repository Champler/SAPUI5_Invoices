		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#logalicourseinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logalicourseinvoices-display": {
								"semanticObject": "logalicourseinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logalicourse.invoices",
									"url": sap.ui.require.toUrl("logalicourse/invoices")
								}
							}
						}
					}
